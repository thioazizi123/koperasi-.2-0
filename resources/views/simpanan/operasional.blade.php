...
@section('content')
    ...
    <div style="margin-top: 2rem; background: white; padding: 2rem; border-radius: 1.5rem; box-shadow: var(--shadow);">
        ...
        <form action="{{ route('simpanan.operasional.store') }}" method="POST" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; align-items: end;">
            ...
            <div>
                ...
                <input type="number" name="amount" required style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 0.5rem; outline: none;" placeholder="Masukkan jumlah...">
            </div>
            <div>
    ...
    <div
        ...
        <h2 style="margin-bottom: 1.5rem; font-size: 1.25rem;">Laporan Dana Operasional Tahun {{ $year }}</h2>
