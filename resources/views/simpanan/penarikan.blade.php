...
@section('content')
    <div class="welcome-section">
        ...
        <p>Halaman ini digunakan untuk mencatat pengambilan kembali uang dari simpanan wajib, simpanan pokok, maupun dana
            operasional oleh anggota.</p>
    </div>
    ...
    <div style="margin-top: 2rem; background: white; padding: 2rem; border-radius: 1.5rem; box-shadow: var(--shadow);">
        ...
        <form action="{{ route('simpanan.penarikan.store') }}" method="POST"
            ...
            @csrf
            <div>
                <label style="display: block; margin-bottom: 0.5rem; font-size: 0.875rem; color: #64748b;">Pilih
                    Anggota</label>
                <input list="member_list" name="member_name" id="member_input" placeholder="Ketik nama anggota..." required
            ...
            <div>
                <label style="display: block; margin-bottom: 0.5rem; font-size: 0.875rem; color: #64748b;">Jenis
                    Simpanan</label>
            ...
            <div>
                <label style="display: block; margin-bottom: 0.5rem; font-size: 0.875rem; color: #64748b;">Jumlah
                    Penarikan</label>
                <input type="number" name="amount" placeholder="0" min="1" required
                    style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 0.5rem; outline: none;">
            </div>
            <div>
                <label style="display: block; margin-bottom: 0.5rem; font-size: 0.875rem; color: #64748b;">Tanggal
                    Penarikan</label>
            ...
            <div>
                <button type="submit"
                    style="width: 100%; background: #ef4444; color: white; padding: 0.75rem; border: none; border-radius: 0.5rem; cursor: pointer; font-weight: 500;">
                    Proses Penarikan
                </button>
            </div>
        </form>
            ...
            <tbody>
                @forelse($withdrawals as $index => $w)
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        ...
                        <td style="padding: 1rem; font-family: monospace; font-weight: 600; color: #64748b;">
                            {{ $w->member->member_no ?? '-' }}
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="5" style="padding: 2rem; text-align: center; color: #64748b;">Belum ada riwayat penarikan.
                        </td>
                    </tr>
                @endforelse
            </tbody>
